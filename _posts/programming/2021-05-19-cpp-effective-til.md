...
2. 이 문제를 해결하기 위해 매크로 대신 상수를 쓰는 것입니다.
...
3. #define을 상수로 교체하려고 할 때 주의해야 할 점이 있습니다.
...
4. 나열자(enumerrator) 타입의 값은 int가 사용되야 할 곳에서도 쓸 수 있는 것을 적극 활용해봅니다.
...
5. 함수처럼 쓰이는 매크로를 만드려면, #define보다는 인라인 함수를 우선적으로 생각합니다.
